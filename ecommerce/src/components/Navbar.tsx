        ...
        <nav className="flex justify-between text-white w-screen">
          <div className="px-5 xl:px-12 py-6 flex w-full items-center">
            ...
            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
              ...
              >
                <div className="hover:text-gray-200">Category</div>
                {isDropdownOpen && (
                  <ul className="absolute left-0 w-48 text-white shadow-lg z-30 bg-black">
                    <li className="hover:bg-gray-800">
                      <NavLink className="block px-4 py-2" to="categories/men">
                        Men
                      </NavLink>
                    </li>
                    <li className="hover:bg-gray-800">
                    ...
                    <li className="hover:bg-gray-800">
                      <NavLink className="block px-4 py-2" to="categories/kids">
                        Kids
                      </NavLink>
                    </li>
                  </ul>
              ...
              <li>
                <NavLink className="hover:text-gray-800" to="#">
                  Collections
                </NavLink>
              </li>
              <li>
          ...
          <NavLink className="xl:hidden flex mr-6 items-center" to="#">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6 hover:text-gray-200"
              fill="none"
