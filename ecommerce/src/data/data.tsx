...
import wsh1 from "../assets/wsh1.jpg";
import wsh2 from "../assets/wsh2.jpeg";
import wsh3 from "../assets/wsh3.webp";
import wsh4 from "../assets/wsh4.webp";
import wsh5 from "../assets/wsh5.webp";
import wsh6 from "../assets/wsh6.jpg";
import wsh7 from "../assets/wsh7.jpeg";
import wsh8 from "../assets/wsh8.jpg";
import wsh9 from "../assets/wsh9.webp";
import wsh10 from "../assets/wsh10.webp";
...
export const productsMenShirt: Product[] = [
  {
    imageSrc: s1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsWomenTrousers: Product[] = [
  {
    imageSrc: tw1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsWomenWatches: Product[] = [
  {
    imageSrc: ww1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsMenWatches: Product[] = [
  {
    imageSrc: w1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsMenShoes: Product[] = [
  {
    imageSrc: sh1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsWomenShirts: Product[] = [
  {
    imageSrc: wsh1,
    brand: "Brand",
    productName: "Product Name",
...
export const productsWomenShoes: Product[] = [
  {
    imageSrc: shw1,
    brand: "Brand",
    productName: "Product Name",
